...
function mapCausa(row) {
  return {
    ...
    area:             row.area             ?? 'Penal',
    materia:          row.materia          ?? '',
    querellante:      row.querellante      ?? null,
    imputado:         row.imputado         ?? null,
    ...
    <div className="flex-1 min-w-0 flex flex-col h-full bg-white overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto fab-clear">
        ...
        {tab === 'analisis' && (
          <AnalisisTab
            causa={causa}
            analisisMeta={analisisMeta} setAnalisisMeta={setAnalisisMeta}
            alertasAnalisis={alertasAnalisis} setAlertasAnalisis={setAlertasAnalisis}
            faltantes={faltantes} setFaltantes={setFaltantes}
            contradicciones={contradicciones} setContradicciones={setContradicciones}
            recomendaciones={recomendaciones} setRecomendaciones={setRecomendaciones}
            documentosDrive={documentosDrive}
