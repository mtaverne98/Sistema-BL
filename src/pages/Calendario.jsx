...
// ── Sample data ───────────────────────────────────────────────────────────────
const EVENTOS_INIT = [
  { id:'ev01', tipo:'audiencia', titulo:'Audiencia preparatoria alimentos', cliente:'Ana Paula Reyes Soto', causa_rit:'F-1234-2025', fecha:'2026-05-18', hora_inicio:'09:00', duracion:60, tribunal:'Juzgado de Familia de Santiago', sala:'Sala 3', modalidad:'presencial', zoom_link:'', responsable:'MT', notas:'Presentar lista de testigos. Llevar documentación económica.' },
  { id:'ev02', tipo:'interno',   titulo:'Reunión equipo — revisión semanal', cliente:'', causa_rit:'', fecha:'2026-05-18', hora_inicio:'14:00', duracion:60, tribunal:'', sala:'', modalidad:'presencial', zoom_link:'', responsable:'MT', notas:'Revisión agenda semana. Asistentes: MT, AB, CL.' },
  { id:'ev03', tipo:'plazo',     titulo:'Plazo contestación demanda laboral', cliente:'Héctor Morales Jiménez', causa_rit:'O-456-2025', fecha:'2026-05-19', hora_inicio:'', duracion:0, tribunal:'Juzgado del Trabajo', sala:'', modalidad:'', zoom_link:'', responsable:'CL', notas:'Plazo legal. No puede extenderse.', allDay:true },
  { id:'ev04', tipo:'tarea',     titulo:'Revisar resoluciones PJUD', cliente:'Héctor Morales Jiménez', causa_rit:'O-456-2025', fecha:'2026-05-19', hora_inicio:'10:00', duracion:60, tribunal:'', sala:'', modalidad:'remoto', zoom_link:'', responsable:'CL', notas:'Verificar notificaciones pendientes.' },
  { id:'ev05', tipo:'reunion',   titulo:'Reunión cliente — mediación familiar', cliente:'María José Contreras Rojas', causa_rit:'F-5678-2024', fecha:'2026-05-19', hora_inicio:'16:00', duracion:90, tribunal:'', sala:'', modalidad:'zoom', zoom_link:'https://zoom.us/j/123456789', responsable:'MT', notas:'Segunda sesión. Revisar acuerdos parciales tenencia.' },
  { id:'ev06', tipo:'fiscalia',  titulo:'Entrevista fiscalía — Carmona', cliente:'Rodrigo Carmona Muñoz', causa_rit:'P-321-2025', fecha:'2026-05-20', hora_inicio:'09:30', duracion:60, tribunal:'Fiscalía Centro Norte', sala:'Oficina 204', modalidad:'presencial', zoom_link:'', responsable:'MT', notas:'Llevar antecedentes penales. Posible formalización próxima semana.' },
  { id:'ev07', tipo:'audiencia', titulo:'Juicio oral laboral', cliente:'Héctor Morales Jiménez', causa_rit:'O-456-2025', fecha:'2026-05-20', hora_inicio:'11:00', duracion:120, tribunal:'Juzgado del Trabajo de Santiago', sala:'Sala 1', modalidad:'presencial', zoom_link:'', responsable:'CL', notas:'Testigo: Fernanda Gómez. Llevar liquidaciones.' },
  { id:'ev08', tipo:'tarea',     titulo:'Analizar liquidación sueldo', cliente:'Héctor Morales Jiménez', causa_rit:'O-456-2025', fecha:'2026-05-20', hora_inicio:'15:00', duracion:60, tribunal:'', sala:'', modalidad:'remoto', zoom_link:'', responsable:'CL', notas:'Verificar cálculo indemnización últimos 12 meses.' },
  { id:'ev09', tipo:'audiencia', titulo:'Control detención — Carmona', cliente:'Rodrigo Carmona Muñoz', causa_rit:'P-321-2025', fecha:'2026-05-21', hora_inicio:'08:00', duracion:60, tribunal:'Juzgado de Garantía de Santiago', sala:'Sala 7', modalidad:'presencial', zoom_link:'', responsable:'MT', notas:'Argumentar medidas cautelares alternativas. Arraigo nacional.' },
  { id:'ev10', tipo:'plazo',     titulo:'Plazo SIAU N°234 — vence hoy', cliente:'Lorena Navarro Pérez', causa_rit:'C-789-2024', fecha:'2026-05-21', hora_inicio:'', duracion:0, tribunal:'', sala:'', modalidad:'', zoom_link:'', responsable:'AB', notas:'Plazo 5 días hábiles. Vence hoy.', allDay:true },
  { id:'ev11', tipo:'reunion',   titulo:'Reunión cliente — antecedentes', cliente:'Patricia Lagos Vidal', causa_rit:'O-234-2025', fecha:'2026-05-21', hora_inicio:'11:30', duracion:60, tribunal:'', sala:'', modalidad:'zoom', zoom_link:'https://zoom.us/j/987654321', responsable:'AB', notas:'Revisar liquidaciones entregadas.' },
  { id:'ev12', tipo:'interno',   titulo:'Revisión semanal equipo', cliente:'', causa_rit:'', fecha:'2026-05-21', hora_inicio:'17:00', duracion:60, tribunal:'', sala:'', modalidad:'presencial', zoom_link:'', responsable:'MT', notas:'Revisión causas activas y tareas pendientes.' },
  { id:'ev13', tipo:'plazo',     titulo:'Plazo fatal — Escrito contestación', cliente:'Ana Paula Reyes Soto', causa_rit:'F-1234-2025', fecha:'2026-05-22', hora_inicio:'', duracion:0, tribunal:'Juzgado de Familia de Santiago', sala:'', modalidad:'', zoom_link:'', responsable:'MT', notas:'Plazo fatal. Ingresar antes de las 24:00.', allDay:true },
  { id:'ev14', tipo:'audiencia', titulo:'Mediación laboral — 1ª sesión', cliente:'Patricia Lagos Vidal', causa_rit:'O-234-2025', fecha:'2026-05-22', hora_inicio:'10:00', duracion:90, tribunal:'Juzgado del Trabajo de Ñuñoa', sala:'Sala 2', modalidad:'presencial', zoom_link:'', responsable:'AB', notas:'Primera sesión mediación. Propuesta económica.' },
  { id:'ev15', tipo:'tarea',     titulo:'Preparar minuta mediación familiar', cliente:'María José Contreras Rojas', causa_rit:'F-5678-2024', fecha:'2026-05-22', hora_inicio:'15:00', duracion:60, tribunal:'', sala:'', modalidad:'remoto', zoom_link:'', responsable:'MT', notas:'Incluir acuerdos tenencia.' },
  { id:'ev16', tipo:'audiencia', titulo:'Audiencia de prueba — pericial', cliente:'Camila Espinoza Torres', causa_rit:'F-9012-2025', fecha:'2026-05-25', hora_inicio:'09:00', duracion:120, tribunal:'Juzgado de Familia de Las Condes', sala:'Sala 1', modalidad:'presencial', zoom_link:'', responsable:'CL', notas:'Declaración testigo perito psicólogo.' },
  { id:'ev17', tipo:'reunion',   titulo:'Reunión pericial psicólogo', cliente:'Camila Espinoza Torres', causa_rit:'F-9012-2025', fecha:'2026-05-27', hora_inicio:'14:00', duracion:60, tribunal:'', sala:'', modalidad:'zoom', zoom_link:'https://zoom.us/j/111222333', responsable:'CL', notas:'Coordinar informe antes del 15/06.' },
]
